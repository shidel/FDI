...
deltree /y %TEMP%\FDISRC\SOURCE\FDISRC\V8POWER\V*.* >NUL
deltree /y %TEMP%\FDISRC\SOURCE\FDISRC\*.CFG >NUL
deltree /y %TEMP%\FDISRC\SOURCE\FDISRC\TOOLS\*.CFG >NUL
set /e TGO=cd
pushd
